...
public class StrutturaCurriculum {
    ...
    private Table table;
    public StrutturaCurriculum(PdfFont font, Table table) {
        this.font = font;
        this.table = table;
    }
    ...
    public void aggiungiIntestazione(String img) throws MalformedURLException {
    ...
    public void aggiungiInformazioniPersonali(Persona persona) {
    ...
    public void aggiungiEsperienzaLavorativa(List<EsperienzaLavorativa> esperienzeLavorative) {
        ...
        for(EsperienzaLavorativa esperienza: esperienzeLavorative){
            ...
            String mansioni = String.join(",", esperienza.getMansioniPrincipale());
            aggiungiRigaNormale("Principali mansioni e responsabilità", mansioni);
            aggiungiRigaVuota();
        }
    }
    public void aggiungiIstruzione(List<Istruzione> istruzioneList){
        ...
        for(Istruzione istruzione: istruzioneList){
            ...
            aggiungiRigaNormale("Nome e tipo di istituto di istruzione o formazione", istruzione.getTipoIstruzione() + ", " + istruzione.getNomeIstituto());
            aggiungiRigaNormale("Qualifica conseguita", istruzione.getQualifica());
            aggiungiRigaVuota();
        }
    }
    public void aggiungiCompetenzeLinguistiche(List<Lingua> lingue){
    ...
    public void aggiungiRigaNormale(String campo, String descrizione) {
